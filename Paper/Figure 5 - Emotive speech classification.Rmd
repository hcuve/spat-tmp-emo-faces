...
# export for revisions - scirep
ggsave("fig4_panel_spoken_ggsidenew.tiff",  paper_plots$panel_spoken_fig5_ggside,
       device = "tiff",
       width = 17,
       # 
       height = 10,
...
ggsave("fig4_panel_spoken_ggsidenew.jpg",  
       paper_plots$panel_spoken_fig5_ggside,
       device = "jpg",
       width = 17,
       # 
...
ggsave("fig4_panel_spoken_ggsidenew.pdf",  
       paper_plots$panel_spoken_fig5_ggside,
       device = "pdf",
       width = 17,
       # 
