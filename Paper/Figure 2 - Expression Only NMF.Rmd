...
# I is for italic
labels <- c(
  `1` = "<img src='https://github.com/hcuve/spat-tmp-emo-faces/raw/main/ggtextimgs/comp1_posed.png'
    width='100' /><br> 1",
  `2` = "<img src='https://github.com/hcuve/spat-tmp-emo-faces/raw/main/ggtextimgs/comp2_posed.png'
    width='100' /><br> 2",
  `3` = "<img src='https://github.com/hcuve/spat-tmp-emo-faces/raw/main/ggtextimgs/comp3_posed.png'
    width='100' /><br> 3"
)
...
# re-export for revision
ggsave("Fig1_panel_NMF_poseddpi300.tiff",device = 'tiff', paper_plots$panel_NMF_posed,
       width = 25,
       height = 25,
       dpi = 300,
           compression = "lzw")
...
ggsave("Fig1_panel_NMF_poseddpi300.jpg",device = 'jpg', paper_plots$panel_NMF_posed,
       width = 25,
       height = 25,
       dpi = 300)

ggsave("Fig1_panel_NMF_poseddpi300.pdf",device = 'pdf', paper_plots$panel_NMF_posed,
       width = 25,
       height = 25,
       dpi = 300)
