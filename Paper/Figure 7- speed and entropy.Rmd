...
export figs revision
```{r}
ggsave("fig_6_plts_substate_entropy.tiff", plts_substate_entropy, device = "tiff",
       width = 14, height = 14, dpi = 300)

ggsave("fig_6_plts_substate_entropy.jpg", plts_substate_entropy, device = "jpg",
       width = 14, height = 14, dpi = 300)

ggsave("fig_6_plts_substate_entropy.pdf", plts_substate_entropy, device = "pdf",
       width = 14, height = 14, dpi = 300)
...
# sci rep revisions export

ggsave("Fig6_speed_entropy.png", paper_plots$Fig7_speed_entropy, device = "png",
       width = 12, height = 5, dpi = 300)
ggsave("Fig6_speed_entropy.tiff", paper_plots$Fig7_speed_entropy, device = "tiff",
       width = 12, height = 5, dpi = 300,    compression = "lzw")
ggsave("Fig6_speed_entropy.pdf", paper_plots$Fig7_speed_entropy, device = "pdf",
