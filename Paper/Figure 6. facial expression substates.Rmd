...
dependenciesL Facial expression substates analyses.Rmd
Figure 6
...
ggsave("fig_6_plts_substate_illustration_hm.tiff", plts_substate_illustration_hm, device = "tiff",
...
ggsave("fig_6_plts_substate_illustration_hm.pdf", plts_substate_illustration_hm, device = "pdf",
       width = 14, height = 14, dpi = 800)
